...
function secondline_psb_notice() {
	if( ! function_exists('secondline_powerpress_options') && ! function_exists('secondline_importer_init') ) {
		if ( ! PAnD::is_admin_notice_active( 'disable-done-notice-180' ) ) {
			return;
		}
		?>
		<div data-dismissible="disable-done-notice-180" class="notice notice-info is-dismissible">
